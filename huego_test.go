...
// 			method: "GET",
// 			path:   "/schedules",
// 			data:   `{ "1": { "name": "Timer", "description": "", "command": { "address": "/bridge/s95jtYH8HUVWNkCO/groups/0/action", "body": { "scene": "02b12e930-off-0" }, "method": "PUT" }, "time": "PT00:01:00", "created": "2014-06-23T13:39:16", "status": "disabled", "autodelete": false, "starttime": "2014-06-23T13:39:16" }, "2": { "name": "Alarm", "description": "", "command": { "address": "/bridge/s95jtYH8HUVWNkCO/groups/0/action", "body": { "scene": "02b12e930-off-0" }, "method": "PUT" }, "localtime": "2014-06-23T19:52:00", "time": "2014-06-23T13:52:00", "created": "2014-06-23T13:38:57", "status": "disabled", "autodelete": false } }`,
// 		},
// 		{
// 			method: "GET",
// 			path:   "/schedules/1",
// 			data:   `{ "name": "Wake up", "description": "My wake up alarm", "command": { "address": "/bridge/<username>/groups/1/action", "method": "PUT", "body": { "on": true } }, "time": "W124/T06:00:00" }`,
// 		},
// 		{
// 			method: "POST",
// 			path:   "/schedules",
...
// 		if test.url == "" {
// 			test.url = fmt.Sprintf("https://%s/bridge%s", hostname, test.path)
// 		}
